...
{
    public partial class _40LForm : RMESForm
    {
        ...
        {
            _csvFileName = "MES 40L prod. record.csv";
        ...
        protected override void BuildFormData()
        {
            ...
            _formData.AddFormDataGroup(new FormDataGroup(lblEndTime, dtpEndTime, dt));
        ...
        private void btnForward_Click(object sender, EventArgs e)
        {
            ...
            FormData fd = new FormData(this);
            if (fd._currentPage == -1)
            {
                foreach (Control c in _endControls)
                {
                    c.Enabled = false;
